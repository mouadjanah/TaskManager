<template>
    <div>
        ...
        <vs-dialog v-model="addTaskModel" prevent-close blur>
            <template #header>
                <h4 class="not-margin">Add New <b>Task</b></h4>
            </template>
            <form v-on:submit.prevent="addTask()" id="addTaskForm">
                ...
                <div class="form-group mt--3">
                    ...
                    <input
                        ...
                        v-model="addPostData.description_user"
                    />
                </div>
                <div class="form-group mt--3">
            ...
            <form v-on:submit.prevent="updateTask()" id="editTaskForm">
                ...
                <div class="form-group mt--3">
                    ...
                    <input
                        class="form-control"
                        placeholder="Description"
                        v-model="editPostData.description_user"
                    />
                </div>
                <div class="form-group mt--3">
                    <label class="form-control-label">Status</label>
                    <select
                        class="form-control"
                        @change="onEditChangeStatus($event)"
                        ref="getStatus"
                    >
                        <option value="0">Select Status</option>
                        <option value="PENDING">Pending</option>
...
export default {
    ...
    methods: {
        ...
        addTask() {
            ...
            this.axios
                .post("api/v1/add/task", this.addPostData)
                .then((response) => {
        ...
        updateTask() {
            ...
            this.axios
                .put("/api/v1/update/task", this.editPostData)
                .then((response) => {
        ...
        deleteTask() {
            ...
            this.axios
                .delete("/api/v1/delete/task/" + this.deletePostData.id)
                .then((response) => {
                    if (response.data.status === true) {
        ...
        editBtn(id) {
            ...
            this.axios
                ...
                .then((response) => {
                    ...
                    this.editPostData.description_user = item.description_user;
