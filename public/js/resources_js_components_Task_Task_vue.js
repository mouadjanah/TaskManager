  ...
  methods: {
    ...
    editBtn: function editBtn(id) {
      ...
      this.axios.get("/api/v1/get/task/" + id).then(function (response) {
        ...
        _this5.editPostData.description_user = item.description_user;
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    }), _vm._v(" "), _c("span", [_c("strong", [_vm._v("Edit")])])]), _vm._v(" "), _c("button", {
    ...
    }), _vm._v(" "), _c("span", [_c("strong", [_vm._v("Delete")])])])])])])]);
  }), 0)], 1)]), _vm._v(" "), _vm.dataNotFound ? _c("tbody", [_vm._m(3)]) : _vm._e()])])])])]), _vm._v(" "), _c("vs-dialog", {
    attrs: {
      "prevent-close": "",
      blur: ""
    },
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        ...
        }, [_vm._v("Add New "), _c("b", [_vm._v("Task")])])];
      },
      proxy: true
    }]),
    model: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.addPostData.description_user,
      expression: "addPostData.description_user"
    }],
    staticClass: "form-control",
    attrs: {
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.addPostData, "description_user", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group mt--3"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.editPostData.description_user,
      expression: "editPostData.description_user"
    }],
    staticClass: "form-control",
    attrs: {
      placeholder: "Description"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.editPostData, "description_user", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group mt--3"
