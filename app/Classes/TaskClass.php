...
class TaskClass
{
    ...
    public function addTask($name, $due_date, $description_user, $status)
    {
        try {
            $email = Common::AuthID();
            $addProduct = $this->task->addTask($email,$name, $due_date, $description_user, $status);
            if ($addProduct) {
    ...
    public function updateTask($id,$name, $due_date, $description_user, $status)
    {
        try {
            $updateProduct = $this->task->updateTask($id,$name, $due_date, $description_user, $status);
            if ($updateProduct) {
